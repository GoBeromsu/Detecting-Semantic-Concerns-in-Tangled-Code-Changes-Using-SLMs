#!/usr/bin/env python3
"""
GGUF Conversion Script for Qwen3-14B Fine-tuned Models
...
def merge_lora_adapter() -> bool:
    ...
    logger.info(
        f"🌐 HF Hub Delegation: Loading LoRA adapter from {HF_ADAPTER_REPO} and merging with base model on CPU..."
    )
