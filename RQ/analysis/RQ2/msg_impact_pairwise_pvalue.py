...
- Â₁₂ > 0.5: msg0 (without message) tends to have higher HL (worse) → with message is better
- Â₁₂ < 0.5: msg0 (without message) tends to have lower HL (better) → without message is better
- Â₁₂ = 0.5: no difference
